...
<model modelUID="r:456c657b-7acf-4413-95dd-bacea8767ab1(net.alexanderkiel.rat.JratDsl.behavior)">
  ...
  <node type="jetbrains.mps.lang.behavior.structure.ConceptBehavior" id="7989151587928930468">
    <link role="concept" targetNodeId="1.7989151587928930455:0" resolveInfo="JsonAssert" />
    <node role="method" type="jetbrains.mps.lang.behavior.structure.ConceptMethodDeclaration" id="7989151587928930471">
      <property name="name" value="needsDatabaseRule" />
      <property name="isVirtual" value="false" />
      <property name="isAbstract" value="false" />
      <link role="overriddenMethod" targetNodeId="8307750758729928794" resolveInfo="needsDatabaseRule" />
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="7989151587928930472" />
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7989151587928930473">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7989151587928930474">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.BooleanConstant:3" id="7989151587928930475" />
        </node>
      </node>
      <node role="returnType" type="jetbrains.mps.baseLanguage.structure.BooleanType:3" id="7989151587928930476" />
    </node>
    <node role="constructor" type="jetbrains.mps.lang.behavior.structure.ConceptConstructorDeclaration" id="7989151587928930469">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7989151587928930470" />
    </node>
  </node>
</model>
