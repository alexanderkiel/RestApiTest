...
<model modelUID="r:57fe7fe8-ecb1-40f0-a2b7-69bc58725434(net.alexanderkiel.rat.JratDsl.editor)">
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="736961497060892650">
    <link role="conceptDeclaration:32" targetNodeId="1.736961497060733632:0" resolveInfo="Test" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="6901432874814385024">
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="6901432874814385025" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="6901432874814385027">
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="6901432874814385028">
          <property name="flag:32" value="false" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="6901432874814385031">
          <property name="text:32" value="baseURI" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="6901432874814385033">
          <link role="relationDeclaration:32" targetNodeId="1.6901432874814385023:0" resolveInfo="baseUri" />
        </node>
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="6901432874814385030" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Block:32" id="1667099485251985423">
        <node role="header:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1667099485251985425">
          ...
          <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1667099485251985429">
            <link role="relationDeclaration:32" targetNodeId="1.1667099485251985420:0" resolveInfo="uri" />
          </node>
        </node>
        <node role="body:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1844326167509696817">
          <link role="relationDeclaration:32" targetNodeId="1.736961497060733633:0" />
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="736961497060893592">
    <link role="conceptDeclaration:32" targetNodeId="1.736961497060893223:0" resolveInfo="ResponseStatusAssert" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="736961497060893594">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="736961497060893597">
        <property name="text:32" value="assert status equals" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1844326167509714121">
        <property name="noTargetText:32" value="&lt;enter status&gt;" />
        <property name="attractsFocus:32" value="2" />
        <link role="relationDeclaration:32" targetNodeId="1.1844326167509714119:0" />
      </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1667099485251985431">
    <link role="conceptDeclaration:32" targetNodeId="1.1667099485251985416:0" resolveInfo="TestCase" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="6901432874814455338">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1844326167509699076">
        ...
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1844326167509699078">
          ...
          <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1844326167509699084">
            <property name="attractsFocus:32" value="2" />
            <property name="noTargetText:32" value="&lt;enter method&gt;" />
            <link role="relationDeclaration:32" targetNodeId="1.1667099485251985434:0" />
          </node>
          <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="6901432874814359010">
            <link role="relationDeclaration:32" targetNodeId="1.6901432874814359008:0" />
            <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="6901432874814359011" />
          </node>
        ...
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1844326167509714124">
          <link role="relationDeclaration:32" targetNodeId="1.1844326167509714122:0" />
      ...
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="6901432874814455342" />
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="6901432874814456516" />
    </node>
  </node>
  <visible index="3" modelUID="r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)" />
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="983088790783728428">
    <link role="conceptDeclaration:32" targetNodeId="1.983088790783728425:0" resolveInfo="HeaderAssert" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="983088790783728430">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="983088790783728433">
        <property name="text:32" value="assert header equals" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="983088790783728436">
        <link role="relationDeclaration:32" targetNodeId="1.983088790783728426:0" resolveInfo="name" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="983088790783728438">
        <link role="relationDeclaration:32" targetNodeId="1.983088790783728427:0" resolveInfo="value" />
        <link role="styleClass:32" targetNodeId="3v.1186415563770" resolveInfo="StringLiteral" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="983088790783728432" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="6901432874814442552">
    <link role="conceptDeclaration:32" targetNodeId="1.6901432874814442550:0" resolveInfo="StringContentAssert" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="6901432874814442554">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="6901432874814442555">
        <property name="text:32" value="assert string content equals" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="6901432874814442557">
        <link role="relationDeclaration:32" targetNodeId="1.6901432874814442551:0" resolveInfo="value" />
        <link role="styleClass:32" targetNodeId="3v.1186415563770" resolveInfo="StringLiteral" />
      </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="5041098170606071435">
    ...
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="5041098170606071437">
      ...
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="6670678901860273184">
        ...
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutIndentStyleClassItem:32" id="6670678901860319168">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="6670678901860319167" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="6670678901860273172">
    <link role="conceptDeclaration:32" targetNodeId="1.6670678901860273169:0" resolveInfo="XPathAssert" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="6670678901860273174">
      ...
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="6670678901860273181">
