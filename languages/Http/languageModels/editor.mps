...
<model modelUID="r:412722de-894f-4bf6-a3bc-619ffc05077f(net.alexanderkiel.rat.Http.editor)">
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="736961497060733621">
    <link role="conceptDeclaration:32" targetNodeId="1.736961497060733617" resolveInfo="Invocation" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="736961497060733623">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="736961497060733630">
        <link role="relationDeclaration:32" targetNodeId="1.736961497060733620" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="736961497060733628">
        <link role="relationDeclaration:32" targetNodeId="1.736961497060733619" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="736961497060733625" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="736961497060733634">
    <link role="conceptDeclaration:32" targetNodeId="1.736961497060723102" resolveInfo="Resource" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="736961497060733636">
      <link role="relationDeclaration:32" targetNodeId="1.736961497060733606" resolveInfo="uri" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="736961497060733637">
    <link role="conceptDeclaration:32" targetNodeId="1.736961497060733615" resolveInfo="GetMethod" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="736961497060733639">
      <property name="text:32" value="GET" />
    </node>
  </node>
